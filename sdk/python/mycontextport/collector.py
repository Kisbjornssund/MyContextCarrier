"""
BaseCollector — the interface every MyContextPort collector must implement.
"""
...
from mycontextport.types import CollectorHealth, ContextItem


class BaseCollector(abc.ABC):
    """
    Abstract base class for all MyContextPort context collectors.
    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        Args:
            config: Collector-specific configuration dictionary, sourced from
                    the user's ~/.mycontextport/config.yaml collector section.
        """
