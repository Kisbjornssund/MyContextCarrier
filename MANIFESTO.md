...
---
Hei from Finland!
While we were observing something quietly got broken in the GenAI revolution. This is our answer. 

The models and their interfaces got extraordinary. Vibe coding revolutionised access to coding to nearly everyone. We started making magical demos but somehow forgot a few things. 
Every single day, billions of people open an AI tool and begin the same ritual: re-explaining themselves.
...
Over and over, app by app, session by session. The AI that is supposed to be intelligent has no memory of ours to own. The AI that is supposed to help you has really no idea who you are. Not to mention that our privacy matters too.
...
The leading AI systems are built to be amnesiac by design not because memory is technically hard, but because memory is commercially valuable! 

Your context, accumulated and stored in their systems, is not a service they offer you. It is an asset they extract from you.

When a company holds your context, they hold your professional history, your intellectual patterns, your projects, your relationships, your ambitions, your fears, maybe even your medical history. 

They know what you're doing or building before you are ready. They know what problems you have, or haven't solved. They know what questions reveal the limits of your understanding.

This is very intimate data. And the business model of cloud AI is to accumulate as much of it as possible, use it to improve their models, and lock you into their ecosystem because leaving means losing the intelligence that has come to know: you and from you.

The alternatives offered to us are not real alternatives. 

"Bring your own memory" systems that upload your data to yet another cloud. App-specific memory that works in one product and nowhere else. 
Local tools that require you to manually curate everything the AI should be learning automatically. 
Enterprise solutions that cost thousands of dollars a month and still don't give you ownership.

We are being offered the appearance of sovereignty while the substance is extracted and distilled.

---

### What We Actually Want

We want AI that knows us. This is a reasonable desire. 

It is not a luxury or an advanced feature. It is the basic premise of working with an intelligent system over time.

This system could be and should be at least partly ours.
...
We want this to work across every AI tool we use, not just the one whose parent company owns our memories and styles.

We want to be able to inspect what is known about us. To correct it. To even delete it. To export it. To move it. To understand exactly what context is being used in any given conversation.

We want to own this layer of our digital lives. Can we do it?
...
Infrastructure that runs locally and keeps your data on your machine. 

Infrastructure that speaks to every AI model through open standards. 

Infrastructure that gets more valuable the longer you use it because it compounds your context and doesn't do it in order to lock you in. 

Infrastructure that any developer can inspect, modify, extend, or fork.
...
The first version is already being built. The architecture is open. The issues are labeled. 
