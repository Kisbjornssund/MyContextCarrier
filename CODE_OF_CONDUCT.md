...
This Code of Conduct applies within all community spaces, including the GitHub repository, Discord server, and any other official ContextGenOS channels. It also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers at **conduct@contextgenos.dev**. All complaints will be reviewed and investigated promptly and fairly.
