...
This Code of Conduct applies within all community spaces, including the GitHub repository, Discord server, and any other official MyContextPort channels. It also applies when an individual is officially representing the community in public spaces.
